    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="bg-primary/20 py-12 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-6">
            <img
              src="/friendly-elderly-woman-smiling-warmly.jpg"
              alt="Moni - Ihre Alltagshelferin"
              className="w-24 h-24 md:w-32 md:h-32 rounded-full mx-auto border-4 border-white shadow-lg"
            />
          </div>
          <h1 className="text-3xl md:text-5xl font-bold text-foreground mb-4 text-balance">Moni&#39;s Alltagshilfe </h1>
          <p className="text-lg md:text-xl text-muted-foreground mb-6 text-pretty">
            Schön, dass Sie da sind! Ich bin Moni und helfe Ihnen im Raum Malsch/Karlsruhe gerne im Alltag.
          </p>
          <div className="flex items-center justify-center gap-2 text-muted-foreground">
            <MapPin className="w-4 h-4" />
            <span>Karlsruhe & Malsch</span>
          </div>
        </div>
      </header>
      ...
      <section className="py-12 px-4 bg-muted/30">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12 text-foreground">Meine Angebote</h2>
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <Card className="bg-card border-border shadow-sm hover:shadow-md transition-shadow">
              ...
              <CardContent>
                <CardDescription className="text-center text-muted-foreground leading-relaxed">
                  Sicheres Abholen von der Schule und liebevolle Betreuung Ihrer Kinder. Mit Geduld und Erfahrung sorge
                  ich dafür, dass sich Ihre Kleinen wohlfühlen.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card border-border shadow-sm hover:shadow-md transition-shadow">
              ...
              <CardContent>
                <CardDescription className="text-center text-muted-foreground leading-relaxed">
                  Hilfe bei Behördengängen, Besorgungen oder anderen alltäglichen Aufgaben. Gemeinsam schaffen wir das!
                </CardDescription>
              </CardContent>
            </Card>
          </div>
  ...
  <div className="max-w-5xl mx-auto">
    ...
    <div className="flex justify-center">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <a
                href="mailto:monis.alltagshilfe@gmail.com"
      ...
      <footer className="bg-muted/20 py-8 px-4 border-t border-border">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-muted-foreground mb-2">© 2024 Moni&#39;s Alltagshilfe  </p>
          <p className="text-sm text-muted-foreground">Karlsruhe & Malsch • Mit Herz und Erfahrung für Sie da</p>
        </div>
      </footer>
    </div>
  )
